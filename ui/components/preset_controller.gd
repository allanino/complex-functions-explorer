...
func _connect_preset_dirtiers():
	...
	for slider in [
		...
		main_ui.menu_overlay.multivalued_slider, main_ui.menu_overlay.camera_height_slider, main_ui.menu_overlay.speed_slider, main_ui.menu_overlay.rendering_scale_slider
	]:
