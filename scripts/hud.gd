...
# New UI Node Paths
@onready var tab_container = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer")
@onready var func_button = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/FUNCTION/Margin/VBox/FuncDropdown")
@onready var height_button = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/FUNCTION/Margin/VBox/HeightDropdown")
@onready var height_a_container = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/FUNCTION/Margin/VBox/HeightAContainer")
@onready var height_a_input = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/FUNCTION/Margin/VBox/HeightAInput")
@onready var height_eps_container = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/FUNCTION/Margin/VBox/HeightEpsContainer")
@onready var height_eps_input = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/FUNCTION/Margin/VBox/HeightEpsInput")
@onready var iter_container = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/FUNCTION/Margin/VBox/IterContainer")
@onready var iter_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/FUNCTION/Margin/VBox/IterSlider")
@onready var iter_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/FUNCTION/Margin/VBox/IterValue")
@onready var rational_container = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/FUNCTION/Margin/VBox/RationalContainer")
@onready var rational_input = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/FUNCTION/Margin/VBox/RationalInput")
@onready var multivalued_container = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/FUNCTION/Margin/VBox/MultivaluedContainer")
@onready var multivalued_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/FUNCTION/Margin/VBox/MultivaluedSlider")
@onready var multivalued_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/FUNCTION/Margin/VBox/MultivaluedValue")

@onready var re_input = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/NAVIGATION/Margin/VBox/ReInput")
@onready var im_input = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/NAVIGATION/Margin/VBox/ImInput")
@onready var speed_input = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/NAVIGATION/Margin/VBox/SpeedInput")
@onready var zoom_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/NAVIGATION/Margin/VBox/ZoomSlider")
@onready var zoom_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/NAVIGATION/Margin/VBox/ZoomValue")
@onready var zero_speed_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/NAVIGATION/Margin/VBox/ZeroSpeedSlider")
@onready var zero_speed_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/NAVIGATION/Margin/VBox/ZeroSpeedValue")
@onready var zero_proximity_nav_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/NAVIGATION/Margin/VBox/ZeroProximityNavSlider")
@onready var zero_proximity_nav_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/NAVIGATION/Margin/VBox/ZeroProximityNavValue")
@onready var camera_height_input = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/NAVIGATION/Margin/VBox/CameraHeightInput")
@onready var auto_walk_checkbox = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/NAVIGATION/Margin/VBox/AutoWalkContainer/AutoWalkControl/AutoWalkCheckbox")

@onready var terrain_detail_button = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/GRAPHICS/Margin/VBox/TerrainDetailDropdown")
@onready var aa_button = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/GRAPHICS/Margin/VBox/AADropdown")
@onready var color_scheme_button = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/ColorSchemeDropdown")
@onready var view_distance_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/GRAPHICS/Margin/VBox/ViewDistanceSlider")
@onready var view_distance_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/GRAPHICS/Margin/VBox/ViewDistanceValue")
@onready var curves_checkbox = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/CurvesContainer/CurvesControl/CurvesCheckbox")
@onready var critical_checkbox = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/CriticalContainer/CriticalControl/CriticalCheckbox")
@onready var flow_checkbox = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/FlowContainer/FlowControl/FlowCheckbox")
@onready var freeze_time_checkbox = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/FreezeTimeContainer/FreezeTimeControl/FreezeTimeCheckbox")
@onready var day_duration_container = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/DayDurationContainer")
@onready var day_duration_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/DayDurationSlider")
@onready var day_duration_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/DayDurationValue")
@onready var day_time_container = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/StaticTimeContainer")
@onready var day_time_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/StaticTimeSlider")
@onready var day_time_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/StaticTimeValue")
@onready var sunrise_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/SunriseSlider")
@onready var sunrise_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/SunriseValue")
@onready var sky_luminosity_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/SkyLuminositySlider")
@onready var sky_luminosity_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/SkyLuminosityValue")
@onready var sun_luminosity_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/SunLuminositySlider")
@onready var sun_luminosity_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/SunLuminosityValue")
@onready var self_illumination_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/SelfIlluminationSlider")
@onready var self_illumination_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/SelfIlluminationValue")
@onready var fog_density_container = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/FogDensityContainer")
@onready var fog_density_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/FogDensitySlider")
@onready var fog_density_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/ENVIRONMENT/Margin/VBox/FogDensityValue")
@onready var shadows_checkbox = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/GRAPHICS/Margin/VBox/ShadowsContainer/ShadowsControl/ShadowsCheckbox")

@onready var hud_complex_checkbox = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/HUD/Margin/VBox/HudComplexContainer/HudComplexControl/HudComplexCheckbox")
@onready var hud_navigation_checkbox = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/HUD/Margin/VBox/HudNavigationContainer/HudNavigationControl/HudNavigationCheckbox")
@onready var hud_zeros_checkbox = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/HUD/Margin/VBox/HudZerosDetectionContainer/HudZerosDetectionControl/HudZerosDetectionCheckbox")
@onready var rvm_checkbox = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/HUD/Margin/VBox/RvmContainer/RvmControl/RvmCheckbox")
@onready var hud_monitor_fps_checkbox = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/HUD/Margin/VBox/HudMonitorFpsContainer/HudMonitorFpsControl/HudMonitorFpsCheckbox")
@onready var hud_monitor_chunks_checkbox = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/HUD/Margin/VBox/HudMonitorChunksContainer/HudMonitorChunksControl/HudMonitorChunksCheckbox")
@onready var hud_scale_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/HUD/Margin/VBox/HudScaleSlider")
@onready var hud_scale_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/HUD/Margin/VBox/HudScaleValue")

@onready var master_volume_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/AUDIO/Margin/VBox/MasterVolumeSlider")
@onready var master_volume_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/AUDIO/Margin/VBox/MasterVolumeValue")
@onready var bg_music_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/AUDIO/Margin/VBox/BgMusicSlider")
@onready var bg_music_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/AUDIO/Margin/VBox/BgMusicValue")
@onready var drone_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/AUDIO/Margin/VBox/DroneSlider")
@onready var drone_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/AUDIO/Margin/VBox/DroneValue")
...
@onready var brightness_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/BrightnessSlider")
@onready var brightness_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/BrightnessValue")
@onready var saturation_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/SaturationSlider")
@onready var saturation_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/SaturationValue")
@onready var albedo_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/AlbedoSlider")
@onready var albedo_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/AlbedoValue")
@onready var emission_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/EmissionSlider")
@onready var emission_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/EmissionValue")
@onready var metallic_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/MetallicSlider")
@onready var metallic_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/MetallicValue")
@onready var roughness_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/RoughnessSlider")
@onready var roughness_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/RoughnessValue")

@onready var surface_texture_slider = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/SurfaceTextureSlider")
@onready var surface_texture_value = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/SurfaceTextureValue")
@onready var morph_button = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/TabContainer/TERRAIN/Margin/VBox/MorphDropdown")
...
@onready var apply_button = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/ButtonsHBox/ApplyButton")
@onready var close_button = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/ButtonsHBox/CloseButton")
@onready var quit_button = menu_overlay.get_node("CenterContainer/MainMenuPanel/MarginContainer/ContentVBox/ButtonsHBox/QuitDropdown")
